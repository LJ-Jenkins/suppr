...
- [`stop2()`](https://lj-jenkins.github.io/suppr/reference/stop2.md),
  ...
  wrappers for [`base::stop()`](https://rdrr.io/r/base/stop.html),
...
- [`path()`](https://lj-jenkins.github.io/suppr/reference/suppr-helpers.md) -
  ...
  Option to specify if the path is on a shared drive, prepending
  `.Platform$file.sep` if so.
- [`dims()`](https://lj-jenkins.github.io/suppr/reference/suppr-helpers.md) -
  returns the dimensions of an object, or `c(length(x), 0L)` if it has
  no dim attribute.
