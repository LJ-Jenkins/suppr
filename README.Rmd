...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/suppr)](https://CRAN.R-project.org/package=suppr)
...
* `rm.prefix()` and `rm.suffix()` - remove a specified prefix or suffix from each element of a character vector.
