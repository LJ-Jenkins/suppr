...
are in the right-hand side. This is implemented in the same way as base
R and will be replaced by the base version in the R versions that have
it.
...
either the left-hand side or right-hand side, depending on the result of
the operator.
