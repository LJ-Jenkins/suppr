...
#' `0` will give the call to `stopifnot2()` itself, `1` will give the
...
#' call stack will be clamped to the boundary. environment, which will
#' be matched against the calling stack and the corresponding call
#' will be shown.
